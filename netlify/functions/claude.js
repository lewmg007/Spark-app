...
// This function runs on Netlify's servers — your API key never touches the user's device
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      headers: {
        'Content-Type': 'application/json',
        'x-api-key': process.env.ANTHROPIC_API_KEY, // ← your key, stored securely in Netlify
